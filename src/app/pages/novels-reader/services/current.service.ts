...
export class CurrentService {
  ...
  async _init(source: string, comic_id: string, chapter_id: string) {
    ...
    const _res = await Promise.all([this.DbController.getPages(chapter_id, { source: source }), this.DbController.getDetail(comic_id, { source: source }), this._getChapterIndex(chapter_id) ])
