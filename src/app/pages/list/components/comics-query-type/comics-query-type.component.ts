...
@Component({
  selector: 'app-comics-query-type',
  templateUrl: './comics-query-type.component.html',
  styleUrls: ['./comics-query-type.component.scss']
})
export class ComicsQueryTypeComponent {
  order = 1;
  list = [
    {
      key: "",
