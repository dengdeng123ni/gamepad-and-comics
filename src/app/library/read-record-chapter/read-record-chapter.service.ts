...
import { ReadRecordChapterComponent } from './read-record-chapter.component';

@Injectable({
  providedIn: 'root'
})
export class ReadRecordChapterService {
  ...
  open(data?: any) {
    ...
    if (this.opened == false) {
      ...
      const dialogRef = this._dialog.open(ReadRecordChapterComponent, {
